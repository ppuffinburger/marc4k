...
internal class Marc8EscapeSequenceGeneratorTest {
    ...
    private val testData = listOf(
        ...
        TestData("CJK - Escape", 0x31,
            CodeTableTracker(), CodeTableTracker().copy(g0 = 0x31), "\u001B\u0024\u0031")
        )
