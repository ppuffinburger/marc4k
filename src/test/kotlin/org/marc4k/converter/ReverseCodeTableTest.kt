...
import org.marc4k.converter.marc8.CodeTableTracker
...
internal class ReverseCodeTableTest {
    ...
    private val getBestCharacterSetTestData = listOf(
        BestCharacterSetData("Space", ' ', CodeTableTracker(), 0x42, CodeTableTracker(characterSetsUsed = mutableSetOf(0x42, 0x45))),
        BestCharacterSetData("Exclamation outside of used character sets", '!', CodeTableTracker(0x31, 0x34), 0x42, CodeTableTracker(0x31, 0x34, mutableSetOf(0x31, 0x34, 0x42))),
        BestCharacterSetData("Cyrillic Tshe", 'Ћ', CodeTableTracker(), 0x51, CodeTableTracker(characterSetsUsed = mutableSetOf(0x42, 0x45, 0x51))),
        BestCharacterSetData("Arabic Noon with 3 Dots Above", 'ڽ', CodeTableTracker(), 0x34, CodeTableTracker(characterSetsUsed = mutableSetOf(0x42, 0x45, 0x34))),
        BestCharacterSetData("Greek Capital Alpha", 'Α', CodeTableTracker(), 0x53, CodeTableTracker(characterSetsUsed = mutableSetOf(0x42, 0x45, 0x53))),
        BestCharacterSetData("Greek Small Alpha", 'α', CodeTableTracker(), 0x53, CodeTableTracker(characterSetsUsed = mutableSetOf(0x42, 0x45, 0x53))),
        BestCharacterSetData("Right Double Quotation Mark (Greek)", '”', CodeTableTracker(), 0x53, CodeTableTracker(characterSetsUsed = mutableSetOf(0x42, 0x45, 0x53))),
        BestCharacterSetData("Right Double Quotation Mark (Arabic)", '”', CodeTableTracker(0x33, 0x34), 0x33, CodeTableTracker(0x33, 0x34, mutableSetOf(0x33, 0x34))),
        BestCharacterSetData("Character not found in any code tables", 'ṷ', CodeTableTracker(), null, CodeTableTracker())
    )
