...
class CommunityLeader : Leader {
    ...
    var kindOfData by Delegates.observable(
        KindOfData.fromValue(
    ...
    var undefinedPosition17 by Delegates.observable(_implementationDefined2[0]) {
            _, _, newValue -> _implementationDefined2[0] = newValue
    }
